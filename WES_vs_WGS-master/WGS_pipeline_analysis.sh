...
# Paired ends WGS sequencing pipeline
...
# The two fastq files should be in the same repertory (/WGS/fastq)
...
mkdir -p /WGS/bam/$1-b37/logs
mkdir /WGS/bam/$1-b37/tmpdir
